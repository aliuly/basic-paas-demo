...
variable "environment" {
  description = "Environment label appended to the instance name (dev, staging, prod…)"
  type        = string
}
...
variable "ssl" {
  description = "Enable SSL/TLS for client connections. Defaults to true. Changing this restarts the instance."
  type        = bool
  default     = true
}
