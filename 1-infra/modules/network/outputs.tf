...
output "ingress_subnet_id" {
  ...
  value       = opentelekomcloud_vpc_subnet_v1.ingress.id
}

output "ingress_network_id" {
  description = "Ingress subnet neutron network ID — required by opentelekomcloud_lb_loadbalancer_v3 network_ids"
  value       = opentelekomcloud_vpc_subnet_v1.ingress.network_id
}

output "ingress_neutron_subnet_id" {
  description = "Ingress subnet neutron subnet ID — required by opentelekomcloud_lb_loadbalancer_v3 subnet_id (vip_subnet_cidr_id)"
  value       = opentelekomcloud_vpc_subnet_v1.ingress.subnet_id
}

output "ingress_subnet_cidr" {
  description = "Ingress subnet CIDR block"
  value       = var.ingress_subnet_cidr
}
